...
\small{Third Edition -- Springer, 2004}}
\maketitle
...
\part{Review of Calculus}						% PART ONE

\include{SLang_UnderGraduateAnalysis_0}			% Sets and Mappings 
%\include{SLang_UnderGraduateAnalysis_1}		% Real Numbers 
%\include{SLang_UnderGraduateAnalysis_2}		% Limits and Continuous Functions 
%\include{SLang_UnderGraduateAnalysis_3}  		% Differentiation
%\include{SLang_UnderGraduateAnalysis_4} 		% Elementary Functions
%\include{SLang_UnderGraduateAnalysis_5}  		% The Elementary Real Integral

\part{Convergence}	         					% PART TWO

%\include{SLang_UnderGraduateAnalysis_6} 		% Normed Vector Spaces
%\include{SLang_UnderGraduateAnalysis_7}  		% Limits
%\include{SLang_UnderGraduateAnalysis_8} 		% Compactness
%\include{SLang_UnderGraduateAnalysis_9} 		% Series
%\include{SLang_UnderGraduateAnalysis_10}  		% The Integral in One Variable

\part{Applications of the Integral}				% PART THREE

%\include{SLang_UnderGraduateAnalysis_11}  		% Approximation with Convolutions
%\include{SLang_UnderGraduateAnalysis_12}  		% Fourier Series
%\include{SLang_UnderGraduateAnalysis_13}  		% Improper Integrals
%\include{SLang_UnderGraduateAnalysis_14}  		% The Fourier Integral

\part{Calculus in Vector Spaces}  				% PART FOUR

%\include{SLang_UnderGraduateAnalysis_15}  		% Functions on n-Space
%\include{SLang_UnderGraduateAnalysis_16}  		% The Winding Number and Global Potential Functions
%\include{SLang_UnderGraduateAnalysis_17}  		% Derivatives in Vector Spaces
%\include{SLang_UnderGraduateAnalysis_18}  		% Inverse Mapping Theorem
%\include{SLang_UnderGraduateAnalysis_19}  		% Ordinary Differential Equations

\part{Multiple Integration}      				% PART FIVE

%\include{SLang_UnderGraduateAnalysis_20}  		% Multiple Integrals
%\include{SLang_UnderGraduateAnalysis_21}  		% Differential Forms
