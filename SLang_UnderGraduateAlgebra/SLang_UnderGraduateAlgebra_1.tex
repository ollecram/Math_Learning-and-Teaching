...
whose identity\footnote{Note that an equivalent expression for $B(n)$, used in the proof, is $n^n/n!$.} 
we want to prove:
\begin{align*}
...
\begin{align*}
A(n+1) &= A(n) \cdot \left(1 + \frac{1}{n}\right)^n \\
       &= \frac{n^{n-1}}{(n-1)!} \cdot \left(1 + \frac{1}{n}\right)^n \\
       &= \frac{n^{n}}{n!} \cdot \left(1 + \frac{1}{n}\right)^n \\
       &= \frac{n^{n}}{n!} \cdot \left(1 + \frac{1}{n}\right)^n \\       
       &= \frac{n^{n-1}}{(n-1)!} \cdot \left(1 + \frac{1}{n}\right) \cdot \left(1 + \frac{1}{n}\right)^{n-1} \\
       &= \frac{n^{n-1}}{(n-1)!} \cdot \left(\frac{n + 1}{n}\right) \cdot \left(1 + \frac{1}{n}\right)^{n-1} \\
       &= \left[\frac{n^{n-1}}{n!}  \right] \cdot \left(\frac{1}{n}\right) \cdot \left(1 + \frac{1}{n}\right)^{n-1}    \\
       &= \left( \frac{n^{n}}{n!} + 1 \right) \cdot \left[ \frac{n^{n-1}}{n!} \cdot \left(1 + \frac{1}{n}\right)^{n-1} \right]   \\
\end{align*}
