...
\include{SLang_UndergraduateAlgebra_1}			% The Integers 
\include{SLang_UndergraduateAlgebra_2}			% Groups 
\include{SLang_UndergraduateAlgebra_3}  		% Rings
\include{SLang_UndergraduateAlgebra_4} 		    % Polynomials
\include{SLang_UndergraduateAlgebra_5}  		% Vector Spaces and Modules
\include{SLang_UndergraduateAlgebra_6} 		    % Some Linear Groups
\include{SLang_UndergraduateAlgebra_7}  		% Field Theory
\include{SLang_UndergraduateAlgebra_8} 		    % Finite Fields
\include{SLang_UndergraduateAlgebra_9} 		    % Finite Fields
\include{SLang_UndergraduateAlgebra_10}  		% The Real and Complex Numbers
\include{SLang_UndergraduateAlgebra_Appendix} 	% Sets 


%\appendixpage
\include{SLang_UndergraduateAlgebra_A}   % Appendix The Natural Numbers \  The Integers \ Infinite Sets
