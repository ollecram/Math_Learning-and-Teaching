...
\small{Third Edition -- Wiley, 2004}}
\maketitle
...
% PRELIMINARIES
\include{Dummit_n_Foote_AbstractAlgebra_00}					% Preliminaries 

% PART I    -- GROUP THEORY 
\part{GROUP THEORY}

\include{Dummit_n_Foote_AbstractAlgebra_01}					% Introduction to Groups 
\include{Dummit_n_Foote_AbstractAlgebra_02}					% Subgroups 
\include{Dummit_n_Foote_AbstractAlgebra_03}					% Quotient Groups and Homomorphisms 
\include{Dummit_n_Foote_AbstractAlgebra_04}					% Group Actions 
\include{Dummit_n_Foote_AbstractAlgebra_05}					% Direct and Semidirect Products and Abelian Groups 
\include{Dummit_n_Foote_AbstractAlgebra_06}					% Further Topics in Group Theory

% PART II   -- RING THEORY
\part{RING THEORY}

\include{Dummit_n_Foote_AbstractAlgebra_07}					% Introduction to Rings 
\include{Dummit_n_Foote_AbstractAlgebra_08}					% Euclidean Domains, Principal Ideal Domains and Unique Factorization Domains 
\include{Dummit_n_Foote_AbstractAlgebra_09}					% Polynomial Rings 

% PART III  -- MODULES AND VECTOR SPACES
\part{MODULES AND VECTOR SPACES}

\include{Dummit_n_Foote_AbstractAlgebra_10}					% Introduction to Module Theory 
\include{Dummit_n_Foote_AbstractAlgebra_11}					% Vector Spaces
\include{Dummit_n_Foote_AbstractAlgebra_12}					% Modules over Principal Ideal Domains 

% PART IV   -- FIELD THEORY AND GALOIS THEORY					% THIS MUST ABSOLUTELY BE COVERED although indices have NOT been created YET
\part{FIELD THEORY AND GALOIS THEORY}                       
 
\include{Dummit_n_Foote_AbstractAlgebra_13}					% Field Theory
\include{Dummit_n_Foote_AbstractAlgebra_14}					% Galois Theory 
...
%\include{Dummit_n_Foote_AbstractAlgebra_15}					% Commutative Rings and Algebraic Geometry 
%\include{Dummit_n_Foote_AbstractAlgebra_16}					% Artinian Rings, Discrete Valuation Rings, and Dedekind Domains 
%\include{Dummit_n_Foote_AbstractAlgebra_17}					% Introduction to Homological Algebra and Group Cohomology 
...
%\include{Dummit_n_Foote_AbstractAlgebra_18}					% Representation Theory and Character Theory 
%\include{Dummit_n_Foote_AbstractAlgebra_19}					% Examples and Applications of Character Theory 

%\appendixpage
%\include{Dummit_n_Foote_AbstractAlgebra_A1}                    % Cartesian Products and Zorn's Lemma
%\include{Dummit_n_Foote_AbstractAlgebra_A2}                    % Category Theory
